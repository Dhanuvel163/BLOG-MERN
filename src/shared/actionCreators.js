...
export const postusercase=(title,image,body)=>(dispatch)=>{
    var newcase={
        title,
        image,
        body
    ...
    return fetch(baseUrl+'api/useraccounts/newBlog',{
        method: "POST",
...
export const fetchusercases=()=>(dispatch)=>{
    ...
    if(isloggedin() && isuserloggedin()){
        return fetch(baseUrl+'api/useraccounts/blogs',{
            headers: {
                "Content-Type": "application/json",
                "authorization":localStorage.getItem('token')
              },
...
export const fetchallcases=()=>(dispatch)=>{
    ...
    if(isloggedin() ){
        return fetch(baseUrl+'api/useraccounts/allcases',{
            headers: {
                "Content-Type": "application/json",
                "authorization":localStorage.getItem('token')
              },
            ...
            .then(Response=>{
                if(Response.success){
                    ...
                    dispatch(allcasesfailed(Response.message))
                }
            })
