  ...
  if (isloggedin() && islawyerloggedin()) {
    return (
      <Card inverse color="danger">
        ...
        <CardBody>
          <CardTitle>
            Mail : {props.profiledata.profiledata.lawyer.email}
          </CardTitle>
          <CardText>
    ...
    return (
      <Card inverse color="danger">
        ...
        <CardBody>
          <CardTitle>
            Mail : {props.profiledata.profiledata.user.email}
          </CardTitle>
          <CardText>
  ...
  render() {
    if (this.props.profiledata.isloading) {
      ...
      return (
        <div
          className="container"
          style={{ marginTop: 50, marginBottom: 50, height: "100%" }}
        >
          <h4 className="text-center">
            <FolderSharedIcon style={{ fontSize: 40, marginRight: 6 }} />
            Edit Profile!
          </h4>
          <div
              ...
              <Col>
                <div className="container">
                  <Media
                    ...
                    src="https://www.elegantthemes.com/blog/wp-content/uploads/2019/08/things-successful-blogs-have-in-common-featured-image.jpg"
                  ></Media>
                </div>
              </Col>
            </Row>
